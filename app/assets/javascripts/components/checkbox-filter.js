App.CheckboxFilter = function(params) {
  this.params = params
...
App.CheckboxFilter.prototype.setupStatusBox = function() {
...
App.CheckboxFilter.prototype.updateStatusBox = function(params) {
...
App.CheckboxFilter.prototype.onTextBoxKeyUp = function(e) {
  var ENTER_KEY = 13
...
App.CheckboxFilter.prototype.cleanString = function(text) {
...
App.CheckboxFilter.prototype.filterCheckboxes = function() {
...
App.CheckboxFilter.prototype.getAllCheckboxes = function() {
  return this.checkboxesContainer.find('.govuk-checkboxes__item')
}

App.CheckboxFilter.prototype.getAllVisibleCheckboxes = function() {
  return this.getAllCheckboxes().filter(function(i, el) {
    return $(el).css('display') == 'block'
  })
}

App.CheckboxFilter.prototype.getAllVisibleCheckedCheckboxes = function() {
  return this.getAllVisibleCheckboxes().filter(function(i, el) {
    return $(el).find('.govuk-checkboxes__input')[0].checked
  })
}

App.CheckboxFilter.prototype.setContainerHeight = function(height) {
  this.checkboxesContainer.css({
    height: height
  })
}

App.CheckboxFilter.prototype.isCheckboxInView = function(index, option) {
  var $checkbox = $(option)
...
App.CheckboxFilter.prototype.getVisibleCheckboxes = function() {
...
App.CheckboxFilter.prototype.setupHeight = function() {
  var initialOptionContainerHeight = this.checkboxesContainer.height()
